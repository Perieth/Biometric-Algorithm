    ...
    def main(self,image_variable):
        ...
        for (i, rect) in enumerate(rects): #For each face in the picture
            ...
            eyebrowDistance = (p23[0] - p22[0])
                                                 #assuming picture is located in I:/FacesDB/ and using FacesDB naming system
                                                 #FaceDB naming system e.g. s001-0Y
                                                 #Values for Y 0 = neutral, 1 = happy, 2 = sad, 3 = surprised, 4 = angry
            faceData = image_variable[-9:-8]
            print(faceData)
            facialExpressions = [0,0,0,0,0,]
            facialExpressions[int(faceData)] = 1
            ...
            otherUsefulFile.write(str(facialExpressions))
